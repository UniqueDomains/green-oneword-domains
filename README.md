# Available .GREEN One-Word Domains (9,342)
...
Daily-updated dataset of available and resale .green one-word domains from Unique Domains.
...
- `green.csv` — public CSV extract (9,342 rows)
- `green.json` — public JSON extract (9,342 rows)
...
| some.green      | available | $11.99    | $107.99       | 80             | 36     | 4      | name.com                                     |
| wallet.green    | resell    | —         | —             | 74             | 54     | 6      | Xiamen ChinaSource Internet Service Co., Ltd |
...
> Unique Domains. *Available .GREEN One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
