# Available .GREEN One-Word Domains (15,164)
...
**Public extract:** 1,000 rows · **Live catalog:** 15,164 domains · **Median ask:** $95.61 · **High-demand under $2,500:** 2
...
| ------------ | --------- | --------- | ------------- | -------------- | ------ | ------ | -------------------------------------------- |
| away.green   | available | $11.99    | —             | high           | low    | 4      | name.com                                     |
...
> Unique Domains. *Available .GREEN One-Word Domains*. Version 2026-08-14. Public GitHub extract for the exact Unique Domains search represented by this repository.
